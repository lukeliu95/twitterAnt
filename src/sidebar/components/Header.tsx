...
export const Header: React.FC<HeaderProps> = ({ onSettingsClick, onClose }) => {
  return (
    <div className="flex flex-col px-4 pt-3 pb-2 bg-bg-primary">
      <div className="flex items-center justify-between mb-1">
        <div className="flex items-center gap-2">
           ...
           <span className="text-[10px] text-text-tertiary bg-gray-100 px-1.5 py-0.5 rounded">v0.5</span>
        </div>
